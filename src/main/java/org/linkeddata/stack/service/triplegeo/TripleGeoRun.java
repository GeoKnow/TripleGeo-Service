...
public class TripleGeoRun extends HttpServlet {
	...
	static String fileEXT;
	   ...
	   public void init( ){
	      ...
	      outputParams[0] = filePath+"config/config.conf";
	      ...
	      if (!configDir.exists()) {
	  	  ...
	  	  File resultDir = new File(filePath + TripleGeoRun.resultDir);
	      if (!resultDir.exists()) {
	    	  resultDir.mkdirs();
	      }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(request.getParameter("job").equals("db")){
    		...
    		outputParams[1] = filePath+  TripleGeoRun.resultDir + "/result.";
